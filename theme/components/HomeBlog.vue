...
<!--    <ModuleTransition style="margin-top: 80px">-->
<!--      &lt;!&ndash; 自动随机添加名人名言或其他 &ndash;&gt;-->
<!--      <div style="margin: 20px auto 0;max-width: 1126px">-->
<!--        <Boxx></Boxx>-->
<!--      </div>-->
<!--    </ModuleTransition>-->

    <ModuleTransition delay="0.16" style="margin-top: 80px">
...
import { ModuleTransition, RecoIcon } from '@plugins/vuepress-reco/components'
